...
"alignHCenter": "<path d=\"M12 2v20\" /> <path d=\"M8 10H4a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2h4\" /> <path d=\"M16 10h4a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-4\" /> <path d=\"M8 20H7a2 2 0 0 1-2-2v-2c0-1.1.9-2 2-2h1\" /> <path d=\"M16 14h1a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-1\" />",
...
"alignVCenter": "<path d=\"M2 12h20\" /> <path d=\"M10 16v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-4\" /> <path d=\"M10 8V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v4\" /> <path d=\"M20 16v1a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-1\" /> <path d=\"M14 8V7c0-1.1.9-2 2-2h2a2 2 0 0 1 2 2v1\" />",
...
"duplicate": "<line x1=\"15\" x2=\"15\" y1=\"12\" y2=\"18\" /> <line x1=\"12\" x2=\"18\" y1=\"15\" y2=\"15\" /> <rect width=\"14\" height=\"14\" x=\"8\" y=\"8\" rx=\"2\" ry=\"2\" /> <path d=\"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2\" />",
...
function svg(name,o){
  ...
  const d=PATHS[name];
  if(!d) return '';
  const s=o.size||DEFAULTS.size, sw=o.stroke||DEFAULTS.stroke;
  return '<svg class="ic'+(o.cls?' '+o.cls:'')+'" width="'+s+'" height="'+s+'"'
...
function set(el,name,o){ if(el) el.innerHTML=svg(name,o); }
/** Swap every [data-icon] element in a subtree. */
function hydrate(root){
  (root||document).querySelectorAll('[data-icon]').forEach(el=>{
    const n=el.getAttribute('data-icon');
    if(PATHS[n]) el.innerHTML=svg(n,{size:+el.getAttribute('data-icon-size')||undefined});
  });
}
