...
function isBackdrop(type){ const m=REG[type]; return !!(m&&m.backdrop); }
function label(type){ const m=REG[type]; return m?m.label:type; }
...
window.FxStack={REG,LEGACY_ORDER,meta,slotOf,isBackdrop,label,types,
  entryOn,inSlot,activeMaterial,shadowedMaterials,
  entrySig,prefixSig,validPrefix};
})();
