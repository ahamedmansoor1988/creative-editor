...
/* ---- structure (§ structure) ----
 * The repeater, symmetry and echo — the engines that make copies of a layer —
 * live in public/structure.js since 23 Sep 2026, the first seam cut from this
 * file. The same names are bound here so nothing below had to change. */
const {MAX_PATTERN_INSTANCES, MAX_GRID_AXIS, MAX_GAP, MAX_OFFSET, MAX_JITTER, MAX_HOLES, MIN_SIZE_FACTOR, MIRRORS, MAX_SYMMETRY_COUNT, MAX_SYMMETRY_RADIUS, MAX_SYMMETRY_GAP, MAX_ECHO_COPIES, normalizePattern, normalizeEcho, normalizeSymmetry, patternInstances, echoInstances, instanceBounds, symmetryOps, applySymmetryOp, symmetryInstances, derivedInstances}=window.Structure;
...
/* ---- colour ----
 * Hex, rgb, alpha strings and blending live in public/color.js since 23 Sep
 * 2026, the second seam cut from this file. The same names are bound here so
 * nothing below had to change. */
const {stopColor, rgbHex, hexRgb, mixHex, mixIn, hexAlpha, hexToRgba, rampMix, hexDist, meanHexOf, dominantHexes}=window.Color;
